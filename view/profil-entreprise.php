    ...
    <div class="profil">
        <div class="photo">
            <div>
                ...
                <form class="uploadPhoto" id="updateImageForm" action="../Profil-entreprise-be/imageUpdate.php"
                    method="POST" enctype="multipart/form-data">
                    <?php if (!empty($image)): ?>
                        <img src="<?php echo htmlspecialchars('../Profil-entreprise-be/' . $image); ?>"
                            alt="Photo de profil" width="250" height="250">
                    <?php else: ?>
                        <img src="../Profil-entreprise-be/image/default.png" alt="Photo de profil par défaut" width="250"
                            height="250">
                    <?php endif; ?>
                            ...
                            <tr>
                                <th>
                                    ...
                                    <input type="text" name="<?php echo FIELD_NAME; ?>" id="<?php echo FIELD_NAME; ?>"
                                        style="display:none;" disabled maxlength="255">
                                    <button type="submit" id="apply-<?php echo FIELD_NAME; ?>" style="display:none;"
        ...
        <div class="aPropos">
            ...
            <form id="updateDataForm" action="../Profil-entreprise-be/dataUpdate.php" method="POST">
                <th>
                    <span id="label-<?php echo FIELD_APROPOS_ENTREPRISE; ?>"
                        onclick="showInput('<?php echo FIELD_APROPOS_ENTREPRISE; ?>')">
                        <span id="<?php echo FIELD_APROPOS_ENTREPRISE; ?>-value"></span>
                    </span>
                    <textarea name="<?php echo FIELD_APROPOS_ENTREPRISE; ?>"
                        id="<?php echo FIELD_APROPOS_ENTREPRISE; ?>" style="display:none;" disabled maxlength="500"
                        rows="10" cols="50"></textarea>
                    <button type="submit" id="apply-<?php echo FIELD_APROPOS_ENTREPRISE; ?>" style="display:none;"
                        onclick="applyInput('<?php echo FIELD_APROPOS_ENTREPRISE; ?>')">Appliquer</button>
                </th>
            </form>
