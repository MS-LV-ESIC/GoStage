...
<body>
    ...
    <div class="container">
        <div class="d-flex justify-content-center align-items-center" style="margin-top: 5%; margin-bottom: 30%;">
            ...
            <div class="form shadow" style="min-width: 350px; max-width: 400px; width: 100%; background: rgba(255, 255, 255, 0.774); padding: 30px; border-radius: 3%;">
                ...
                <form action="register.php" method="POST">
                    ...
                    <button type="button" onclick="location.href='connexion.html'" class="btn w-100 mt-1" style="color: rgba(0, 76, 170, 1);">Se
                        connecter ?</button>
